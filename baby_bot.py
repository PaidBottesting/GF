...
# --- Gemini 2.0 Flash Chat Function ---
def ask_gemini(prompt):
    url = f"https://generativelanguage.googleapis.com/v1beta2/models/chat-bison-001:generateMessage?key={GEMINI_API_KEY}"
    data = {
    ...
    if r.status_code == 200:
        result = r.json()
        return result["candidates"][0]["message"]["content"]
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    help_text = (
        ...
        "/image - Receive a romantic image.\n"
        "/dateidea - I’ll give you a cute date idea.\n"
        "/vibe - Choose my vibe (sweet, clingy, etc.).\n"
        "/mood - Find out how I'm feeling.\n"
        "/hug - I’ll give you a hug (admin only).\n"
        "/kiss - I’ll give you a kiss (admin only).\n"
        "Just talk to me and I’ll always reply with love!"
    )
